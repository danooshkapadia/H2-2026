...
- **🩺 Machine Health Board** (one row per relay/job; every job's last step is a heartbeat here — Last fired · Status · This week fires/expected; the morning brief reads it and surfaces misses): database https://app.notion.com/p/1520d9ba78f7446d8cfda56882a76c8f · data source `collection://11e8a50e-86d8-4c0b-bc3f-b6637c1066b9`
...
- **The two canonical task databases** (never mix them):
  - **All Tasks [CC]** — client-facing tasks only: https://app.notion.com/p/64b21b86c247835090ee81f2951d17fb · data source `collection://ca821b86-c247-82af-8b2c-070d7a88f1b2` · person property **Assignee** · set the 🔨 Client Projects relation when the task belongs to a client. Never file Notion Fixes here.
  - **All Internal Tasks [CC]** — internal work + ALL Notion Fixes: https://app.notion.com/p/b3a21b86c24783b6a1f58122289e2722 · data source `collection://ced21b86-c247-82f9-82d4-073be67b2ace` · person property **Access** (there is no Assignee here)
  - **Lou's fix queue**: All Internal Tasks [CC] entries titled "Notion Fix: [issue]" with Access = Lou; the Friday wrap emails her the open list (louisianna@danooshkapadia.com)
  - Disambiguation: `43321b86c24782fc8ae0813d9f2fb698` (used by earlier Cowork jobs) is a linked VIEW of All Tasks [CC] — same `ca821b86` data source; point everything at the `64b21b86` page and retire the `43321b86` reference. `aed21b86c24782018f29812c80591807` is the "Internal Tasks" hub page that merely displays All Internal Tasks [CC] — fine to link for a human, NEVER a write target; writes go to `b3a21b86` / `ced21b86`.
